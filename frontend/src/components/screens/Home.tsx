...
const Home = () => {
   ...
   return (
      <div className={styles.home}>
         ...
         <p>
            3. Choose a shape by clicking the corresponding button and confirm a
         ...
         <section>
            ...
            <p></p>
            <p className="box">Choose your shape: </p>
            <div className="box">
               <button
                  className="button button5"
                  onClick={() => playGame(0, playValue)}
               >
                  Rock
               </button>
               <button
                  className="button button2"
                  onClick={() => playGame(1, playValue)}
               >
                  Scissors
               </button>
               <button
                  className="button button3"
                  onClick={() => playGame(2, playValue)}
               >
                  Paper
               </button>
            </div>
